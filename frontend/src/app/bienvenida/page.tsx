...
const PASOS: Paso[] = [
  ...
  { eyebrow: "El Seguimiento", titulo: "Tu contador de bolsillo", narracion: "Registras cada una de tus transacciones y Atom las registra en tiempo real. Lleva la cuenta de todo, para que después rías por la ganga que pillaste o llores por haber comprado en el máximo histórico justo antes de la caída. Sí: histórico e histérico.", Escena: EscenaSeguimiento },
